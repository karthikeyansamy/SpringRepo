        ...
        for (String project : projects) {
            ...
            while (true) {
                ...
                for (int i = 0; i < initiatives.size(); i += INITIATIVE_BATCH_SIZE) {
                    ...
                    // Expand hierarchies for this batch
                    Map<Integer, Set<Integer>> adjacency = fetchHierarchiesForInitiatives(project, batch);
